            ...
            children: [
              Expanded(
                child: ListView(
                  ...
                  children: [
                    _buildImageBubble("https://via.placeholder.com/299x279"),
                    _buildTextBubble("Got it. Let me take a look...", "Agent"),
                    _buildTextBubble(
                        "I see a woman walking a dog through the woods.\n\n"
                            "Tap and hold the screen to ask questions about the image, or double-tap to take another photo.",
                        "Agent"),
                  ],
                ),
              ),
